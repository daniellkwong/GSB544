...
The best performing setup was Ridge regression using the five best numeric variables, with an MSE of 127,647.26, which was lower than every other model–feature combination.
